...
public class BlogApi
    ...
    @ApiOperation(value = "delete user based on user id")
    ...
    @ApiOperation(value = "delete user 4ever based on user id")
    @DeleteMapping(path = "/admin/user/{id}")
    @ResponseStatus(HttpStatus.OK)
    public void deleteUser4Ever(@PathVariable("id") Long userId)
        {
