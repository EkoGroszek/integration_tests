...
public class BlogApiTest {
    ...
    @Test
    public void getNotExistingBlogUserShouldReturnErrorHTTPNotFound() throws Exception {
    ...
    @Test
    public void postBlogUserShouldReturnErrorHTTPConflict() throws Exception {
        UserRequest user = new UserRequest();
        user.setEmail("john@domain.com");
